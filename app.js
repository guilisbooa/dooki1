    ...
    <section class="dashboard-grid">
        ...
        <article class="panel-card">
          ...
          <form id="store-form" class="stack">
            <div class="form-grid">
              ...
              <div class="field"><label for="store-link">Slug do link</label><input id="store-link" name="linkSlug" value="${state.store.linkSlug}" /></div>
            </div>
      ...
      <aside class="stack">
        ...
        <article class="drawer">
          ...
          <div class="stack small">
            <span><strong>Link da loja:</strong> dooki.app/${state.store.linkSlug}</span>
